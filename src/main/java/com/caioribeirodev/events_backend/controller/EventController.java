...
import com.caioribeirodev.events_backend.service.EventService;
...
public class EventController {
    ...
    @GetMapping("/filter")
    public ResponseEntity<List<EventResponseDTO>> getFilteredEvent(@RequestParam(defaultValue = "0") int page,
        ...
        List<EventResponseDTO> events = eventService.getFilteredEvent(page, size, title, city, uf, startDate, endDate);
